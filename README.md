# 💫 About Me:
👋 Hi, I'm Vlad!<br>Computer Science student & aspiring Android & Java Developer 🚀<br><br>💻 Tech stack:<br>📱 Android: Kotlin, Java, Jetpack Compose, XML<br>🏗️ Architecture: MVVM, Clean Architecture<br>📦 Android Databases: Room Persistence, DataStore, SQLite<br>📡 Networking: Retrofit, OkHttp<br>⚙️ Android Tools: Android SDK, ADB<br>☕ Java: Core Java, Java EE<br>🌱 Spring Ecosystem: Spring Boot, Hibernate/JPA<br>🔐 Security: JWT, Spring Security<br>📦 Backend Databases: PostgreSQL, MySQL, MongoDB <br>🧪 Testing: JUnit, Mockito, Integration tests<br>🚢 DevOps: Docker, GitHub Actions<br>📂 Build Tools: Maven, Gradle<br>🔧 Tools & IDEs: Git, Android Studio, IntelliJ IDEA Ultimate, VSCode, Postman, pgAdmin
