# 💫 About Me:
👋 Hi, I'm Vlad!<br>
Computer Science student & aspiring **Game Developer** 🚀<br><br>

💻 Tech stack:<br>
🎮 Game Development: Unity Engine (2D & 3D), C#<br>
🧠 Gameplay Programming: Player Controllers, Camera Systems, Physics, Collisions<br>
🎥 Cameras: Cinemachine (Position Composer, Follow systems)<br>
🎮 Input: New Unity Input System<br>
🧩 Game Architecture: Game Loops, State-based logic, Prototyping<br><br>

🎨 3D & Assets:<br>
🧱 Blender: Basic Modeling, Scenes, Props<br>
🎨 Materials & Textures, Asset Optimization<br>
📦 Asset Import & Setup in Unity<br><br>
...
![Unity Hub](https://img.shields.io/badge/Unity%20Hub-222C37?style=for-the-badge&logo=unity&logoColor=white)
